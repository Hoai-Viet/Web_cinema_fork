...
@swag_from("../swagger/ticket_type.yaml", methods=["get"])
...
@swag_from("../swagger/ticket_type.yaml", methods=["post"])
...
@swag_from("../swagger/ticket_type.yaml", methods=["put"])
...
@swag_from("../swagger/ticket_type.yaml", methods=["delete"])
